sap.ui.define([
	...
	"use strict";
	return BaseController.extend("com.vinci.timesheet.admin.controller.TimesheetSelectionEquipment", {
		formatter: formatter,
		/**
		 * Called when a controller is instantiated and its View controls (if available) are already created.
		 * Can be used to modify the View before it is displayed, to bind event handlers and do other one-time initialization.
		 * @memberOf com.vinci.timesheet.admin.view.TimesheetSelectionEquipment
		 */
		onInit: function() {
