sap.ui.define([
	...
	return BaseController.extend("com.vinci.timesheet.admin.controller.WeeklySummary", {
		...
		onUpdateFinished: function(oEvent) {
			...
			this._tableTDBackgroundColorFix();
		},
		/* =========================================================== */
		/* User Event methods                                            */
		/* =========================================================== */
		...
		_tableTDBackgroundColorFix: function() {
			var thatControl = this;
			var tableItems = this.getView().byId('table').getItems();
			jQuery.sap.delayedCall(1000, this, function() {
				for(var i; i<tableItems.length; i++){
					var firstCellId = tableItems[i].getCells()[0].getId();
				}
			});
		},
