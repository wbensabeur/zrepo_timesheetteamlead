sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("com/vinci/timesheet/admin/app", ".html");
		...
		return Opa5.extend("com.vinci.timesheet.admin.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["com/vinci/timesheet/admin/localService/mockserver"], function (mockserver) {
